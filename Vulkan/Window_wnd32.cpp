...
void Window::_InitOSWindow() {
    window = glfwCreateWindow(_surface_size_x, _surface_size_y, _window_name.c_str(), NULL, NULL);
}
void Window::_DeInitOSWindow() {
...
void Window::_InitOSSurface() {
    glfwCreateWindowSurface(r->GetVulkanInstance(), window, nullptr, &surface);
}
